...
│   ├── app/
│   │   └── ListViewApplication.kt               # Application class with Dynamic Colors
│   ├── domain/model/
...
│       ├── list/
│       │   └── CustomAdapter.kt                  # ArrayAdapter with ViewHolder for ListView items
│       ├── main/
│       │   ├── MainActivity.kt                   # Navigation host activity
│       │   └── MainFragment.kt                   # Fragment displaying the ListView screen
│       └── utils/
